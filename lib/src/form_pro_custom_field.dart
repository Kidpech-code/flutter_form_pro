...
class FormProCustomField extends StatelessWidget {
  ...
  const FormProCustomField({super.key, required this.formFieldName, required this.builder});
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedSwitcher(
      ...
      child: builder(context, form.getValue(formFieldName), config.error, (val) => form.setValue(formFieldName, val)),
    );
  }
}
